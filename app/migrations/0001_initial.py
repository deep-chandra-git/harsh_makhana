# Generated by Django 4.2.11 on 2026-05-10 05:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('protein', models.DecimalField(decimal_places=1, default=12.0, help_text='Protein in grams per 100g', max_digits=5)),
                ('carbohydrates', models.DecimalField(decimal_places=1, default=70.0, help_text='Carbohydrates in grams per 100g', max_digits=5)),
                ('fiber', models.DecimalField(decimal_places=1, default=12.0, help_text='Fiber in grams per 100g', max_digits=5)),
                ('fat', models.DecimalField(decimal_places=1, default=2.0, help_text='Fat in grams per 100g', max_digits=5)),
                ('iron', models.DecimalField(decimal_places=1, default=8.0, help_text='Iron percentage per 100g', max_digits=5)),
